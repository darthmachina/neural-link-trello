...
external interface ReadableStream<R> {
    ...
    fun getReader(options: `T$30`): ReadableStreamBYOBReader
    fun getReader(): ReadableStreamDefaultReader<R>
    fun <T> pipeThrough(__0: `T$31`<R, T>, options: PipeOptions = definedExternally): ReadableStream<T>
...
external interface XPathEvaluatorBase {
    ...
    fun createExpression(expression: String, resolver: `T$32`? = definedExternally): XPathExpression
    fun createNSResolver(nodeResolver: Node): dynamic /* (prefix: String?) -> String? | `T$32` */
    ...
    fun evaluate(expression: String, contextNode: Node, resolver: `T$32`? = definedExternally, type: Number = definedExternally, result: XPathResult? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$32`? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$32`? = definedExternally, type: Number = definedExternally): XPathResult
}
